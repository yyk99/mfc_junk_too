...
// list_in_tabsDlg.cpp : implementation file
//
...
void ClistintabsDlg::DoDataExchange(CDataExchange* pDX)
{
    CDialogEx::DoDataExchange(pDX);
}
...
// ClistintabsDlg message handlers

BOOL ClistintabsDlg::OnInitDialog()
{
...
void ClistintabsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR ClistintabsDlg::OnQueryDragIcon()
{
